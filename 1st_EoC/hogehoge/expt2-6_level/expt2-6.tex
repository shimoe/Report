...
\begin{equation}
  h(t) = r K \biggl( 1 + \frac{T_1}{T_2 - T_1} e^{- \frac{t}{T_1}} - \frac{T_2}{T_2 - T_1} e^{- \frac{t}{T_2}} \biggr)
\end{equation}
...
%次に，変曲点について，次のように定義する．
%\begin{equation}
%  x \equiv \frac{T_1}{T_A}, \hspace{5mm}
%  y \equiv \frac{T_2}{T_A}, \hspace{5mm}
%  \alpha \equiv \frac{T_C}{T_A} \approx 0.765 , \hspace{5mm}
%\end{equation}
